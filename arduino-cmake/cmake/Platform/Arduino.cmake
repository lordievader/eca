...
function(SETUP_ARDUINO_SIZE_SCRIPT OUTPUT_VAR)
    ...
    file(WRITE ${ARDUINO_SIZE_SCRIPT_PATH} "
        ...
        if (\${SIZE_OUTPUT_LENGTH} STREQUAL 12)
            EXTRACT(SIZE_OUTPUT_LINES 3 FIRMWARE_PROGRAM_SIZE_ROW)
            EXTRACT(SIZE_OUTPUT_LINES 2 FIRMWARE_DATA_SIZE_ROW)
            ...
            set(FIRMWARE_STATUS \"\${FIRMWARE_STATUS} [\${FIRMWARE_PROGRAM_NAME}: \${FIRMWARE_PROGRAM_SIZE}] \")
            set(FIRMWARE_STATUS \"\${FIRMWARE_STATUS} [\${FIRMWARE_DATA_NAME}: \${FIRMWARE_DATA_SIZE}]\")
        ...
        if (\${SIZE_OUTPUT_LENGTH} STREQUAL 14)
            ...
            message(\"FIRMWARE_PROGRAM_SIZE_ROW: \${FIRMWARE_PROGRAM_SIZE_ROW}\")
            message(\"FIRMWARE_DATA_SIZE_ROW: \${FIRMWARE_DATA_SIZE_ROW}\")
